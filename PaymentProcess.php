...
<div style="clear:both">
  <h1 align="center" style="background-color:#909090"><p style="text-shadow:#414141 6px -6px 2px;">(-:  Order Details  :-)</p></h1>
		<div align="center">
					...
					if(!empty($_SESSION["shopping_cart"]))
					{
						...
						?>
							<tr>
								...
								<td><input type="submit" name="payment" value="Payment" class="button button2" /><br/><br/></td>
							</tr>
						<?php
        ...
        <div align="center">
        	Total  :-<input type="text" name="total" id="total" value="$ <?php echo number_format($total, 2);?>" disabled="disabled" /><br />
          <tr>
          	<td>
                <input type="radio" name="process" align="left" />ATM<br />
                <input type="radio" name="process" />BANK<br />
                <input type="radio" name="process" align="left" />HomeDelevery
            </td>
          </tr>
        </div>
